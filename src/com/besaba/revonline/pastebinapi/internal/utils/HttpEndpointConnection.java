...
public class HttpEndpointConnection<T> {
  ...
  public HttpEndpointConnection<T> addParameter(@NonNull final String key, @NonNull final String value) {
    parameters.put(key, value);
    return this;
  }

  public HttpEndpointConnection<T> removeParameter(@NonNull final String key) {
  ...
  private String buildResponse(@NonNull final InputStream source) throws IOException {
