...
public class ItemBuilder2 {
    ...
    public ItemBuilder2 color(Color c) {
    	this.c = c;
	    this.cor = true;
	    return this;
    }
  
    public ItemBuilder2 material(Material material) {
    	this.material = material;
        return this;
    }
  
    public ItemBuilder2 headName(String cabeçaNome) {
	    this.cabeça = true;
    ...
    public ItemBuilder2 inquebravel() {
	    this.inquebravel = true;
	    return this;
    }
  
    public ItemBuilder2 durability(int durability) {
	    this.durability = ((short)durability);
        return this;
    }
  
    public ItemBuilder2 name(String text) {
        if (!this.useMeta) {
            this.useMeta = true;
        }
    ...
    public ItemBuilder2 addEnchant(Enchantment enchantment) {
        return addEnchant(enchantment, Integer.valueOf(1));
    }
  
    public ItemBuilder2 addUnsafeEnchant(Enchantment enchantment, Integer level) {
    ...
    public ItemBuilder2 addEnchant(Enchantment enchantment, Integer level) {
