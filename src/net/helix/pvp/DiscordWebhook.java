...
public class DiscordWebhook {
    ...
    public void execute() throws IOException {
        ...
        final JSONObject json = new JSONObject(null);
        ...
        if (!this.embeds.isEmpty()) {
            ...
            for (final EmbedObject embed : this.embeds) {
                final JSONObject jsonEmbed = new JSONObject(null);
                ...
                if (footer != null) {
                    final JSONObject jsonFooter = new JSONObject(null);
                    jsonFooter.put("text", footer.getText());
                    jsonFooter.put("icon_url", footer.getIconUrl());
                    jsonEmbed.put("footer", jsonFooter);
                }
                if (image != null) {
                    final JSONObject jsonImage = new JSONObject(null);
                    jsonImage.put("url", image.getUrl());
                    jsonEmbed.put("image", jsonImage);
                }
                if (thumbnail != null) {
                    final JSONObject jsonThumbnail = new JSONObject(null);
                    jsonThumbnail.put("url", thumbnail.getUrl());
                    jsonEmbed.put("thumbnail", jsonThumbnail);
                }
                if (author != null) {
                    final JSONObject jsonAuthor = new JSONObject(null);
                ...
                for (final EmbedObject.Field field : fields) {
                    final JSONObject jsonField = new JSONObject(null);
    ...
    public static class EmbedObject
    {
        ...
        private static class Footer
        {
            ...
            private Footer(final String text, final String iconUrl, Footer footer) {
                this.text = text;
        ...
        private static class Thumbnail
        {
            ...
            private Thumbnail(final String url, Thumbnail thumbnail) {
                this.url = url;
            }
        ...
        private static class Image
        {
            ...
            private Image(final String url, Image image) {
                this.url = url;
            }
        ...
        private static class Author
        {
            ...
            private Author(final String name, final String url, final String iconUrl, Author author) {
                this.name = name;
                this.url = url;
                this.iconUrl = iconUrl;
            }
        ...
        private static class Field
        {
            ...
            private Field(final String name, final String value, final boolean inline, Field field) {
                this.name = name;
                this.value = value;
                this.inline = inline;
            }
